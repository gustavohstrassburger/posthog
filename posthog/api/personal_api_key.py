...
class PersonalAPIKeySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        read_only_fields = ["id", "value", "mask_value", "created_at", "last_used_at", "user_id", "last_rotated_at"]
    ...
    def rotate(self, personal_api_key: PersonalAPIKey) -> PersonalAPIKey:
        value = generate_random_token_personal()
        mask_value = mask_key_value(value)
        secure_value = hash_key_value(value)
