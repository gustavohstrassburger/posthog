...
from products.issue_tracker.backend.temporal import (
    ACTIVITIES as ISSUE_TRACKER_ACTIVITIES,
    WORKFLOWS as ISSUE_TRACKER_WORKFLOWS,
)
...
WORKFLOWS_DICT = {
    ...
    ISSUE_TRACKER_TASK_QUEUE: ISSUE_TRACKER_WORKFLOWS,
...
ACTIVITIES_DICT = {
    ...
    ISSUE_TRACKER_TASK_QUEUE: ISSUE_TRACKER_ACTIVITIES,
